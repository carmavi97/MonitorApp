...
public class FormularioActivity extends AppCompatActivity implements FormularioInterface.View {
    ...
    public void add() {
        ...
        Boolean mtl=((CheckBox) findViewById(R.id.MTL)).isChecked();
        String section= ((Spinner) findViewById(R.id.seccion)).getSelectedItem().toString();
        //String email, String photo, String name,boolean mtl,String section,String brithDate
        String birthDate= ((EditText) findViewById(R.id.date)).getText().toString();
        Person person= new Person(email, photo, name,mtl,section,birthDate);
        PersonModel pm=new PersonModel(this);
        pm.insert(person);
    }
